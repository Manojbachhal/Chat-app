...
//   ) {
//     // console.log(this.loggedinusers.token);
...
//     let Userids = userData.map((element: any) => {
//       return element._id;
//     });
...
//     } catch (error) {}
//   }
//   setChatNotification(id: string) {
//     let chatsData = this.chatsSubject.getValue();
//     chatsData = chatsData.map((chat: any) => {
//       chat.notification = chat.id === id; // Set notification flag based on ID match
//       return chat;
//     });
...
//   getChats() {
//     let res;
//     this.chatsSubject.subscribe((val) => (res = val));
//     console.log(res);
//   }
